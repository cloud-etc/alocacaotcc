...
class Revision(models.Model):
    ...
    date_created = models.DateTimeField(_("Criado (a)"), db_index=True, auto_now_add=True,
                                        help_text=_("The date and time this revision was created."))
    comment = models.TextField(_("Comentário"), blank=True, null=True, help_text=_("A text comment on this revision."))

    def __str__(self):
        return 'Revisão: %s' % (self.date_created.strftime('%d-%m-%Y %H:%M'))
...
class Change(models.Model):
    class Meta:
        ordering = ("-pk",)
        verbose_name = _('Modificações')
        verbose_name_plural = _('Todas Modificações')

    ACTIONS = (
        (ADDED, _("Adicionado")),
        (CHANGED, _("Modificado")),
        (DELETED, _("Apagado"))
    )

    date_created = models.DateTimeField(_("Criado"), db_index=True, auto_now_add=True,
                                        help_text=_("The date and time this changes was."))
    user = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.SET_NULL,
                             verbose_name=_("Usuário"), help_text=_("The user who created this changes."))
    ...
    action = models.CharField(_("Ação"), choices=ACTIONS, help_text=_('adicioando|modificado|apagado'), max_length=7)

    def __str__(self):
        return "%s" % (self.date_created.strftime('%d-%m-%Y %H:%M'))
